...
def _(mo):
    ...
    By default, figures are written to the output's assets directory as image files.
    Pass `--self-contained` to embed them directly in the markdown as base64 data URIs.
    """)
    return
